    ...
    <div className="flex items-center justify-center h-screen mb-12 bg-fixed bg-center bg-cover custom-img-landing">
      ...
      <div className="p-5  z-[2] landing-box">
        ...
        <Box display="flex" justifyContent="center" sx={{ p: 1, margin: `0px 0px 0px 0px` }}>
          <p className="flex text-xl m-auto text-center">267 Pacific Coast Hwy</p>
        </Box>
        <Box display="flex" justifyContent="center" sx={{ p: 1, margin: `0px 0px 0px 0px` }}>
          <p className="flex text-xl m-auto text-center">Santa Monica, CA</p>
        </Box>
        <Box display="flex" justifyContent="center" sx={{ p: 1, margin: `0px 0px 0px 0px` }}>
          <p className="flex text-xl m-auto text-center">90402</p>
        </Box>
        <Box display="flex" justifyContent="center" sx={{ p: 1, margin: `0px 0px 0px 0px` }}>
          <p className="flex text-xl m-auto text-center">310-394-9266</p>
        </Box>
        <Box display="flex" justifyContent="center" sx={{ p: 1, margin: `0px 0px 0px 0px` }}>
          <p className="flex text-xl m-auto text-center">
            <a
              target="_blank"
